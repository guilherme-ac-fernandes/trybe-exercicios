...
from computador.main_memory import MainMemory
from computador.secondary_memory import SecondaryMemory
...
def timer(string, start_time):
    """Função auxiliar para print temporizado"""
    print(string)
    print(f"Tempo para a tarefa terminar: {perf_counter() - start_time:6f}\n")
...
# Executar: python3 -m computador.operating_system
