...
def hanoi_tower(numero_de_discos, a, b, c):
    if numero_de_discos == 1:
        print("Move disco %d do %s para %s" % (numero_de_discos, a, c))
    else:
        hanoi_tower(numero_de_discos - 1, a, c, b)
        print("Move disco %d de %s para %s" % (numero_de_discos, a, c))
        hanoi_tower(numero_de_discos - 1, b, a, c)


if __name__ == "__main__":
    hanoi_tower(3, a='primeiro', b='meio', c='fim')
