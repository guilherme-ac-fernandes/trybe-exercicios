...
Refatore o exercício sobre o Reddit que está na branch `exercise-three` do repositório [exercise-contextAPI-refactoring](https://github.com/tryber/exercise-contextAPI-refactoring/tree/master). Modifique a aplicação para utilizar Context API para gerenciar o estado no lugar de Redux.
