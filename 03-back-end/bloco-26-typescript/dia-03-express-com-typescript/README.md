...
Observação: O banco de dados para realização dos exercícios consta abaixo e os README’s constam todos os requisitos necessários para realização de cada um deles.
